    ...
    <div className="flex items-center justify-center gap-8 md:gap-16 pt-20">
      <NavLink
        ...
        className={({ isActive }: { isActive: boolean }) =>
          `flex flex-col items-center justify-center gap-2 cursor-pointer w-14 sm:w-20 h-14 sm:h-20 rounded-full ${
      ...
      <NavLink
        to="/cuisines/Korean"
        className={({ isActive }: { isActive: boolean }) =>
          `flex flex-col items-center justify-center gap-2 cursor-pointer bg-gray-700/80 w-14 sm:w-20 h-14 sm:h-20 rounded-full ${
            isActive ? "bg-orange-500" : "bg-gray-700/80"
          }`
        }
      >
